...
class TestAdditionalDataGeoLookup(TestCase):
    ...
    def mock_csv_downloads(self, m):
        ...
        for areatype, a in GeoLookupSource.SOURCE_URLS.items():
            ...
            with open("./datastore/tests/files/geolookups/{}".format(url_filename), "r") as infile:
    ...
    def test_import_geolookups_with_data(self):
        ...
        with requests_mock.Mocker() as m:
            ...
            self.assertEqual(round(geo_object[0].data['latitude'], 5), round(54.68510808262816, 5))
    ...
    def test_nspl_update_additional_data_beneficiaryLocation(self):
        ...
        self.assertEqual(
            ...
            round(GeoLookup.objects.get(areacode=self.EXISTING_AREA).data['latitude'], 5),
        )
    ...
    def test_nspl_update_additional_data_beneficiaryLocation_prioritised(self):
        ...
        grant = Grant.objects.first()
        grant.data['beneficiaryLocation'][0]['geoCode'] = self.EXISTING_AREA
        grant.data['recipientOrganization'][0]['location'] = [{'geoCode': self.EXISTING_AREA}]
        additional_data = {
            'recipientOrganizationLocation': {
                'lsoa11': self.EXISTING_AREA
            }
        }
